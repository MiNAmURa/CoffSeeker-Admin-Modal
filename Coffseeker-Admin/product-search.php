...
if (isset($_GET["name"])) {
    ...
    $sql = "SELECT product_id, product_name, product_brand, product_category, product_price, product_image, product_valid, product_description, updated_at FROM product WHERE (product_name LIKE '%$name%' OR product_brand LIKE '%$name%' OR product_category LIKE '%$name%') AND product_valid = 1";
