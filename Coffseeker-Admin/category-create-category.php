...
$lastIdSql = "SELECT MAX(categories_id) AS lastId FROM categories";
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container">
                    <form action="action/category/doCreate.php" method="post" class="py-2">
                        <div class="mb-3 row">
                        ...
                        <div class="d-flex justify-content-end">
                            <a class="btn btn-secondary mx-3" href="category.php">取消</a>
