...
(1, '張小蘭', '0912-345678', '女', 'zhangxiaolan@example.com ', '咖啡師證照', 50, '特色咖啡調製', '2020-02-15', 1),
...
(18, 'Howard', '0974518335', '女', 'howard@test.com', '5', 5, '5', '2023-07-11', 1),
(19, 'Howard', '0974518335', '女', 'howard@test.com', '5', 5, '5', '2023-07-11', 0),
(20, 'Howard', '0912-345548', '男', 'how@test.com', '咖啡師證照', 2, '特色咖啡調製', '2023-07-14', 1),
(30, 'Howard', '0988888888', '男', 'ttttt@test.com', '咖啡師證照', 50, '特色咖啡調製', '2023-07-14', 1);
...
(23, '咖啡綜合入門班', 6, 1, 6, 2000, '2023-07-14', '2023-07-28', '2023-07-29', '2023-07-30', 1, 10, '一起來參加咖啡綜合入門班吧！', '', '2023-07-14 13:12:07', 1);
...
--
ALTER TABLE `coffseeker_teachers`
  MODIFY `teacher_id` int(6) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=31;
...
--
ALTER TABLE `course`
  MODIFY `course_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=24;
